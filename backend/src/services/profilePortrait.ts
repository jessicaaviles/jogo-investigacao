...
const profilePortraitPrompt = `Transform the supplied person photo into a realistic cinematic investigative portrait for the game Último Vestígio. Preserve the person's identity, face shape, skin tone, hair, age and recognizable characteristics. Use a contemporary premium crime-series look: 35mm or 50mm lens, moderate depth of field, subtle film grain, low saturation, cool ambient light mixed with warm tungsten, restrained contrast, realistic clothing, natural expression, atmospheric Hotel Vesper / forensic archive setting. No text, no logos, no horror, no blood, no cyberpunk, no neon, no glamour retouching, no exaggerated beauty filter. Return only the generated portrait image.`;
