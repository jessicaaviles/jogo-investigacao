...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return <div className="app-shell">
    <header className="topbar" style={{
      ...
      ...((scrolled || isImmersive) ? { background: 'rgba(10,13,16,0.2)', backdropFilter: 'blur(4px)', WebkitBackdropFilter: 'blur(4px)', borderBottom: isImmersive ? '1px solid rgba(255,255,255,0.05)' : 'none' } : {}),
